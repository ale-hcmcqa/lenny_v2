...
<head>
    ...
    <meta name="author" content="congtytranviet"/>
    <meta name="copyright" content="congtytranviet" />
    ...
    <meta name="dc.rights.copyright" content="congtytranviet">
    <meta name="dc.creator.name" content="congtytranviet">
    <meta name="dc.creator.email" content="sales@hpsoft.vn">
    <meta name="dc.identifier" content="http://congtytranviet.com/">
...
$sqlbannerphai=$this->db->get('tblbannerdoc');
if($sqlbannerphai->num_rows()>0)
{
    $bannerphai=$sqlbannerphai->row();
?>
<div id="divAdRight" style="display: block; position: fixed; top:220px;;z-index:2;">
    <a title="ảnh phải" rel="nofollow"><img src="<?php echo $bannerphai->anh_thumb; ?>" alt="ảnh phải" /></a>   
</div>
<?php 
}
$this->db->where('status',0);
...
$this->db->order_by('ordernum','desc');
$this->db->order_by('id','desc');
$sqlbannertrai=$this->db->get('tblbannerdoc');
if($sqlbannertrai->num_rows()>0)
{
    $bannertrai=$sqlbannertrai->row();
?>   
<div id="divAdLeft" style="display: block; position: fixed; top:220px;z-index:2;">
    <a title="ảnh trái" rel="nofollow"><img style="position:absolute;" src="<?php echo $bannertrai->anh_thumb; ?>" alt="ảnh trái" /></a>    
</div>
<?php 
}
?>
